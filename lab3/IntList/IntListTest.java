...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        assertEquals(IntList.list(5, 4, 3, 2, 1), IntList.reverse(A));
        assertEquals(IntList.list(1), IntList.reverse(IntList.list(1)));
        assertNotEquals(IntList.list(1, 2, 3, 4, 5), A);
